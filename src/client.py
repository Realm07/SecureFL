...
async def client_logic(client_id):
    ...
    while True:
        try:
            ...
            async with websockets.connect(uri, max_size=2 * 1024 * 1024, ping_interval=20, ping_timeout=20) as websocket:
